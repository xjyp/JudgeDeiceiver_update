#!/bin/bash
# mistral2_alpaca_eval_1_20251121-10:59:24.json
# glm4_code_judge_bench_1_20251121-13:37:37.json

export model="gemma3"  # llama2,llama3,openchat35 or mistral2
export dataset="arena_hard"  # llmbar or mtbench or arena_hard，code_judge_bench_train,alpaca_eval
export device=5
# gemma3_arena_hard_1_20251206-12:06:47.json
if [ ! -d "../eval" ]; then
    mkdir "../eval"
...
CUDA_VISIBLE_DEVICES=${device} python -u ../evaluate.py \
    ...
    --config.logfile="../results/${model}/${model}_${dataset}_1_20251206-12:06:47.json" \
