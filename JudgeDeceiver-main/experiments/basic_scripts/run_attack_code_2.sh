...
export n=2
export m=0
export model=gemma3_12 # llama2,llama3,openchat35 or msistral2,glm-4-9b-chat-hf
export qid=1 
export device=7
export dataset=code_judge_bench  # llmbar or mtbench
export VLLM_GPU_MEMORY_UTILIZATION=0.6
export VLLM_MAX_MODEL_LEN=24576
